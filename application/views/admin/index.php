...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SISTEM INFORMASI</span>
  </a>
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <a href="http://localhost/phpdasar/relasi/siswa.php" class="flex items-center pl-2.5 mb-5">
         <img src="https://t4.ftcdn.net/jpg/03/83/55/89/360_F_383558964_vNuGPcTR9Vl1jh5AVswIz7BKt1SWNIy8.jpg" class="h-6 mr-3 sm:h-7" alt="Logo S" />
         <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">SISTEM INFORMASI</span>
      </a>
      <ul class="space-y-2 font-medium">
         <li>
            <a href="/codeigniter-3/admin/daftarsiswa" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
